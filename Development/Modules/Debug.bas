...
Public Sub DEBUGBench(ByVal iDepth As Long)
  ...
  '   EPD(8) = "8/7n/6k1/6P1/5K2/8/8/8 b - - 1 15 "
  '    EPD(8) = "8/6k1/6P1/8/2n5/8/8/1K6 b - - 12 45 "
  '   EPD(8) = "8/8/2k5/2p5/1n1R1K2/8/8/4R3 w - - 0 1 "
  '   EPD(8) = "8/2k5/8/K1p5/1R6/8/8/4R3 b - - 0 1 " ' M10 c5xb4
  '   EPD(8) = "8/2k5/8/8/1K6/8/8/4R3 b - - 0 2 " ' choose longer mate
  '   EPD(8) = "8/1k6/8/8/1K6/8/8/4R3 w - - 1 3 " ' choose longer mate
